...
class UserConnectionsControllerTest < ActionController::TestCase
  ...
  test "should create user_connection" do
    assert_difference('UserConnection.count') do
      post :create, user_connection: { friend: @user_connection.friend, user_1_id: @user_connection.user_1_id, user_2_id: @user_connection.user_2_id }
    end
  ...
  test "should update user_connection" do
    put :update, id: @user_connection, user_connection: { friend: @user_connection.friend, user_1_id: @user_connection.user_1_id, user_2_id: @user_connection.user_2_id }
    assert_redirected_to user_connection_path(assigns(:user_connection))
  end
